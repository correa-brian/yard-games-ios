//
//  YGCreatePlaceViewController.swift
//  yard-games-ios
//
...
class YGCreatePlaceViewController: YGViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func loadView() {
        ...
        btnCancel.addTarget(self,
                            action: #selector(YGCreatePlaceViewController.exit),
    ...
    func textFieldShouldReturn(textField: UITextField) -> Bool {
        ...
        if (index == self.textFields.count-1){ //password field, register
            ...
            placeInfo["admins"] = [YGViewController.currentUser.id!]
            print("\(placeInfo)")
